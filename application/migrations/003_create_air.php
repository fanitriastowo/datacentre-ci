...
class Migration_Create_Air extends CI_Migration {
	...
	public function up() {
		$query = "CREATE TABLE air (
			...
			i_p_a_b_panjang DOUBLE COMMENT 'Panjang Instalasi Pipa Air Bersih',
